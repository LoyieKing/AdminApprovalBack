...
namespace Common.IO
{
    public static class FileHelper
    {
        ...
        public static void CreateDir(this IHostingEnvironment env, string dir)
        {
            if (dir.Length == 0) return;
            var path = Path.Join(env.ContentRootPath, dir);
        ...
        public static void DeleteDir(this IHostingEnvironment env, string dir)
        {
            if (dir.Length == 0) return;
            var path = Path.Join(env.ContentRootPath, dir);
            if (Directory.Exists(path))
        ...
        public static void DeleteFile(this IHostingEnvironment env, string file)
        {
            var path = Path.Join(env.ContentRootPath, file);
            if (File.Exists(path))
            {
                File.Delete(path);
            }
        ...
        /// </summary>
        /// <param name="env"></param>
        /// <param name="path">带后缀的文件名</param>
        /// <param name="content">文件内容</param>
        public static void CreateFile(this IHostingEnvironment env, string path, string content)
        {
        ...
        public static void MoveFile(this IHostingEnvironment env, string dir1, string dir2)
        {
            dir1 = Path.Combine(env.ContentRootPath, dir1);
            dir2 = Path.Combine(env.ContentRootPath, dir2);
        ...
        public static void CopyFile(this IHostingEnvironment env, string dir1, string dir2)
        {
            dir1 = Path.Combine(env.ContentRootPath, dir1);
            dir2 = Path.Combine(env.ContentRootPath, dir2);
        ...
        public static void CopyFolder(string varFromDirectory, string varToDirectory)
        {
            ...
            if (directories.Length > 0)
            {
                ...
                {
                    CopyFolder(d, Path.Combine(varToDirectory, Path.GetFileName(d)));
                }
            }
            ...
            if (files.Length > 0)
            {
                ...
                {
                    File.Copy(s, Path.Combine(varToDirectory, Path.GetFileName(s)), true);
                }
            }
        }
        ...
        public static void DeleteFolderFiles(string varFromDirectory, string varToDirectory)
        {
            ...
            if (directories.Length > 0)
            {
                foreach (string d in directories)
                {
                    DeleteFolderFiles(d, Path.Combine(varToDirectory, Path.GetFileName(d)));
                }
            }
            ...
            if (files.Length > 0)
            {
                foreach (string s in files)
                {
                    File.Delete(Path.Combine(varFromDirectory, Path.GetFileName(s)));
                }
            }
        }
        ...
        /// <param name="env"></param>
        /// <param name="directoryPath">指定目录的绝对路径</param>
        public static void DeleteDirectory(this IHostingEnvironment env, string directoryPath)
        {
            directoryPath = Path.Combine(env.ContentRootPath, directoryPath);
            if (IsExistDirectory(directoryPath))
            {
